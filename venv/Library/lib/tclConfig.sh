...
# installed.
TCL_PREFIX='F:/Courses/Udemy - Complete Data Science,Machine Learning,DL,NLP Bootcamp/CODE/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='F:/Courses/Udemy - Complete Data Science,Machine Learning,DL,NLP Bootcamp/CODE/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='F:/Courses/Udemy - Complete Data Science,Machine Learning,DL,NLP Bootcamp/CODE/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IF:/Courses/Udemy - Complete Data Science,Machine Learning,DL,NLP Bootcamp/CODE/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LF:/Courses/Udemy - Complete Data Science,Machine Learning,DL,NLP Bootcamp/CODE/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='F:/Courses/Udemy - Complete Data Science,Machine Learning,DL,NLP Bootcamp/CODE/venv\Library\lib\tclstub86.lib'
